        ...
        // alert("Name : Muhammad Shahid")
        // alert("Roll No. 02")
        // alert("Email : iamshahid102@gmail.com")
        ...
        // Email = "iamshahid102@gmail.com";
        // alert("My email is " + " " + Email);

        // Book = "A Smarter\n way to learn JavaScript";
        // alert("I'm Trying to learn from this Book " + Book);
        ...
        //     var birthYear=1999;
        //     document.write("My birth year is " + " " + String(birthYear) + "<br>" +"Data Type of my declare variable is number" + "<br>");
